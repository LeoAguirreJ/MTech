...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_DIAGNOSTICO = "diagnostico";
    ...
    private static final String TABLE_CREATE_CITA = "create table cita(" +
    ...
    public void crearCita(DatosCita c){

        db = this.getWritableDatabase();
        ContentValues values = new ContentValues();

        values.put(COLUMN_CEDULA, c.getCedula());
        values.put(COLUMN_DIAGNOSTICO, c.getDiagnostico());
        values.put(COLUMN_DESCRIPCION, c.getDescripcion());
        values.put(COLUMN_FECHA, c.getFecha());
        values.put(COLUMN_HORA, c.getHora());
